...
// R3F Canvas через dynamic, чтобы не было SSR-ошибок
...
const RISKS: Record<RiskKey, { label: string; range: [number, number]; color: string }> = {
...
function simulateSeries({ days, dailyRange, deposit }: { days: number; dailyRange: [number, number]; deposit: number }) {
  ...
  return (
    <div className="bg-[#0a0a0a] text-white font-sans">
      ...
      <section className="max-w-7xl mx-auto px-6 py-24 grid md:grid-cols-2 gap-12 items-center">
        <div>
          <motion.h1 className="text-5xl md:text-7xl font-extrabold leading-tight" initial={{ y: 20, opacity: 0 }} animate={{ y: 0, opacity: 1 }}>
        ...
        <div className="h-[400px] rounded-3xl overflow-hidden border border-yellow-300/30 shadow-2xl bg-black">
          <Canvas camera={{ position: [0, 2, 6], fov: 45 }}>
            ...
            <Suspense fallback={null}>
              ...
              <Coin color="dodgerblue" position={[2, -1, -1]} />
              <Coin color="limegreen" position={[1, 2, -3]} />
